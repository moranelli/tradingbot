...
class TestStrategy(bt.Strategy):
    ...
    params = (
        ...
        ('reward_ratio', 19),  #Se divide por 10 para obtener valor con decimales. Ej: 13 - 1.3
        ('risk_perc', 5.0),
...
if __name__ == '__main__':
    ...
    strats = cerebro.optstrategy(
        TestStrategy,
        fast_ma_period=range(8, 11),
        #slow_ma_period=range(34, 61),
        #ema_50_period=range(50, 101),
        ssl_period=range(8, 24),
        SL_ATRlen=range(8, 14),
        sl_atr=range(8, 11),
    ...
    datapath = ('data/BTCUSDT_2022_5minutes_testnet.csv')
