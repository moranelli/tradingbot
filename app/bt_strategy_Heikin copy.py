...
class TestStrategy(bt.Strategy):
    ...
    params = (
        ...
        ('slow_ma_period', 54),
        ('SL_ATRlen', 12),
        ('sl_atr', 9), #Se divide por 10 para obtener valor con decimales. Ej: 9 - 0.9
    ...
    def __init__(self):
        ...
        self.datahl2 = (self.datas[0].high + self.datas[0].low) / 2
        ...
        # Add indicator
        self.slow_ma = bt.indicators.SMA(self.datas[0], period=self.params.slow_ma_period, plotname='slow_ma')
        self.fast_ma = bt.indicators.EMA(self.datas[0], period=self.params.fast_ma_period, plotname='fast_ma')
        self.atr = bt.indicators.ATR(self.datas[0], period=self.params.SL_ATRlen, plotname='atr', plotabove=False)
    ...
    def next(self):
        self.log('%f, %f, %f, %f, %f' % (
            self.data.high[0], self.data.low[0], self.data.open[0], self.data.close[0], (self.data.high[0] + self.data.low[0]) / 2), doprint=False, printtime=True, tofile=False)
